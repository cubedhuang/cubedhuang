...
- [🌎 My Personal Website](https://dan.onl), made with SvelteKit, TypeScript, and TailwindCSS. It uses Spotify's API to include a now-listening section a breakdown of my most-listened Spotify tracks!
- [📖 nimi.li](https://nimi.li), an interactive Toki Pona dictionary aggregating data from _sona Linku_, lipamanka's semantic spaces, and the public subset of _Toki Pona Dictionary_ by jan Sonja. Search in Toki Pona or with English keywords, customize your font and color scheme, browse Luka Pona signs, and more!
...
- [🕊️ Boids](https://boids.dan.onl), a flocking simulation with tons of different parameters to mess around with. It uses PixiJS for rendering and is optimized with a spatial subdivision system. Inspired by the Coding Train's flocking simulation coding challenge.
